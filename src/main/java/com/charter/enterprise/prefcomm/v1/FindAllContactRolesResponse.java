...
/**
 * <p>Java class for findAllContactRolesResponse complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="findAllContactRolesResponse">
 *   &lt;complexContent>
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *       &lt;sequence>
 *         &lt;element name="return" type="{http://www.charter.com/enterprise/prefcomm/v1}contactRole" maxOccurs="unbounded" minOccurs="0"/>
...
@XmlType(name = "findAllContactRolesResponse", propOrder = {
    "_return",
    "charterHeaderOutputInfo"
})
public class FindAllContactRolesResponse {

    @XmlElement(name = "return")
    protected List<ContactRole> _return;
     ...
     * 
     */
    public List<ContactRole> getReturn() {
        if (_return == null) {
            _return = new ArrayList<ContactRole>();
        }
        return this._return;
    }

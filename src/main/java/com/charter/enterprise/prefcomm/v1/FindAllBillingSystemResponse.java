...
/**
 * <p>Java class for findAllBillingSystemResponse complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="findAllBillingSystemResponse">
 *   &lt;complexContent>
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *       &lt;sequence>
 *         &lt;element name="return" type="{http://www.charter.com/enterprise/prefcomm/v1}billingSystem" maxOccurs="unbounded" minOccurs="0"/>
...
@XmlType(name = "findAllBillingSystemResponse", propOrder = {
    "_return",
    "charterHeaderOutputInfo"
})
public class FindAllBillingSystemResponse {

    @XmlElement(name = "return")
    protected List<BillingSystem> _return;
     ...
     * 
     */
    public List<BillingSystem> getReturn() {
        if (_return == null) {
            _return = new ArrayList<BillingSystem>();
        }
        return this._return;
    }

...
/**
 * <p>Java class for findAllContactMethodsResponse complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="findAllContactMethodsResponse">
 *   &lt;complexContent>
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *       &lt;sequence>
 *         &lt;element name="return" type="{http://www.charter.com/enterprise/prefcomm/v1}contactMethod" maxOccurs="unbounded" minOccurs="0"/>
...
@XmlType(name = "findAllContactMethodsResponse", propOrder = {
    "_return",
    "charterHeaderOutputInfo"
})
public class FindAllContactMethodsResponse {

    @XmlElement(name = "return")
    protected List<ContactMethod> _return;
     ...
     * 
     */
    public List<ContactMethod> getReturn() {
        if (_return == null) {
            _return = new ArrayList<ContactMethod>();
        }
        return this._return;
    }

...
/**
 * <p>Java class for findAllServiceEventsResponse complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="findAllServiceEventsResponse">
 *   &lt;complexContent>
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *       &lt;sequence>
 *         &lt;element name="return" type="{http://www.charter.com/enterprise/prefcomm/v1}serviceEvent" maxOccurs="unbounded" minOccurs="0"/>
...
@XmlType(name = "findAllServiceEventsResponse", propOrder = {
    "_return",
    "charterHeaderOutputInfo"
})
public class FindAllServiceEventsResponse {

    @XmlElement(name = "return")
    protected List<ServiceEvent> _return;
     ...
     * 
     */
    public List<ServiceEvent> getReturn() {
        if (_return == null) {
            _return = new ArrayList<ServiceEvent>();
        }
        return this._return;
    }

...
public class GetScheduleListResponse {
     ...
     * {@link GetScheduleListResponse.Schedule }
     * 
     * 
     */
    public List<GetScheduleListResponse.Schedule> getSchedule() {
        if (schedule == null) {
            schedule = new ArrayList<GetScheduleListResponse.Schedule>();
        }
    ...
    public static class Schedule {
        ...
        protected List<GetScheduleListResponse.Schedule.Time> time;
        @XmlElement(name = "Audit")
        protected GetScheduleListResponse.Schedule.Audit audit;
         ...
         * <p>
         * Objects of the following type(s) are allowed in the list
         * {@link GetScheduleListResponse.Schedule.Time }
         * 
         * 
         */
        public List<GetScheduleListResponse.Schedule.Time> getTime() {
            if (time == null) {
                time = new ArrayList<GetScheduleListResponse.Schedule.Time>();
            }
            return this.time;
        }
         ...
         * @return
         *     possible object is
         *     {@link GetScheduleListResponse.Schedule.Audit }
         *     
         */
        public GetScheduleListResponse.Schedule.Audit getAudit() {
            return audit;
        }
         ...
         *     
         */
        public void setAudit(GetScheduleListResponse.Schedule.Audit value) {
            this.audit = value;
        }

...
/**
 * <p>Java class for findAllUIApplicationsResponse complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="findAllUIApplicationsResponse">
 *   &lt;complexContent>
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *       &lt;sequence>
 *         &lt;element name="return" type="{http://www.charter.com/enterprise/prefcomm/v1}uiApplication" maxOccurs="unbounded" minOccurs="0"/>
...
@XmlType(name = "findAllUIApplicationsResponse", propOrder = {
    "_return",
    "charterHeaderOutputInfo"
})
public class FindAllUIApplicationsResponse {

    @XmlElement(name = "return")
    protected List<UiApplication> _return;
     ...
     * 
     */
    public List<UiApplication> getReturn() {
        if (_return == null) {
            _return = new ArrayList<UiApplication>();
        }
        return this._return;
    }

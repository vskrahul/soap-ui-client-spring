 ...
 * 
 */
@WebServiceClient(name = "Weather", targetNamespace = "http://ws.cdyne.com/WeatherWS/", wsdlLocation = "file:/D:/workSpaces/rest/csg/src/main/resources/wsdl/weather.wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            ...
            url = new URL(baseUrl, "file:/D:/workSpaces/rest/csg/src/main/resources/wsdl/weather.wsdl");
        } catch (MalformedURLException e) {
            logger.warning("Failed to create URL for the wsdl Location: 'file:/D:/workSpaces/rest/csg/src/main/resources/wsdl/weather.wsdl', retrying as a local file");

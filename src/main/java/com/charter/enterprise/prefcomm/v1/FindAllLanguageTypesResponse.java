...
/**
 * <p>Java class for findAllLanguageTypesResponse complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="findAllLanguageTypesResponse">
 *   &lt;complexContent>
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *       &lt;sequence>
 *         &lt;element name="return" type="{http://www.charter.com/enterprise/prefcomm/v1}languageType" maxOccurs="unbounded" minOccurs="0"/>
...
@XmlType(name = "findAllLanguageTypesResponse", propOrder = {
    "_return",
    "charterHeaderOutputInfo"
})
public class FindAllLanguageTypesResponse {

    @XmlElement(name = "return")
    protected List<LanguageType> _return;
     ...
     * 
     */
    public List<LanguageType> getReturn() {
        if (_return == null) {
            _return = new ArrayList<LanguageType>();
        }
        return this._return;
    }

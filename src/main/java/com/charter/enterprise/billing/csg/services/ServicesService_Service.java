 ...
 * 
 */
@WebServiceClient(name = "ServicesService", targetNamespace = "http://charter.com/enterprise/billing/csg/services", wsdlLocation = "file:/D:/workSpaces/rest/csg/src/main/resources/wsdl/eai/ServicesService.wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            ...
            url = new URL(baseUrl, "file:/D:/workSpaces/rest/csg/src/main/resources/wsdl/eai/ServicesService.wsdl");
        } catch (MalformedURLException e) {
            logger.warning("Failed to create URL for the wsdl Location: 'file:/D:/workSpaces/rest/csg/src/main/resources/wsdl/eai/ServicesService.wsdl', retrying as a local file");

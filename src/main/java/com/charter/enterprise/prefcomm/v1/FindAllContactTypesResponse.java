...
/**
 * <p>Java class for findAllContactTypesResponse complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="findAllContactTypesResponse">
 *   &lt;complexContent>
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *       &lt;sequence>
 *         &lt;element name="return" type="{http://www.charter.com/enterprise/prefcomm/v1}contactType" maxOccurs="unbounded" minOccurs="0"/>
...
@XmlType(name = "findAllContactTypesResponse", propOrder = {
    "_return",
    "charterHeaderOutputInfo"
})
public class FindAllContactTypesResponse {

    @XmlElement(name = "return")
    protected List<ContactType> _return;
     ...
     * 
     */
    public List<ContactType> getReturn() {
        if (_return == null) {
            _return = new ArrayList<ContactType>();
        }
        return this._return;
    }

...
public enum ResultReturnCode2 {
    ...
    public static ResultReturnCode2 fromValue(String v) {
        for (ResultReturnCode2 c: ResultReturnCode2 .values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
